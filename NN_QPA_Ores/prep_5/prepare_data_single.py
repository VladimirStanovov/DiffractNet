...
xml_name = f'Ores_{num_phases}ph_p10'
model_ver = 'v1_n001'
...
two_theta_range = (5.8+0.000000517647*40, 90.000)  # in degrees
...
class DiffractionDataset(Dataset):
    def __init__(self, _two_theta_range, _step, num_samples):
...
def main():
    ...
    while i*num_smp_per_run < 150000:
