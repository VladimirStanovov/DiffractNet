...
arg_wghts = generate_tshx_fractions(files)
...
two_theta_range = (5.0, 90.003)  # in degrees
...
def main():
    ...
    #sample_info, PHASES_INFO = parse_xml('OSO_NN_midKO_11ph_dbg_B508_limits.tshx')
    sample_info, PHASES_INFO = parse_xml_multi('.\\PolusD8_Cu.tshx', files)
    #sample_info, PHASES_INFO = parse_xml('OSO_NN_midKO_11ph_noized001.tshx')
    print(f'Loaded {len(PHASES_INFO)} phases.')

    initialize_structures(PHASES_INFO, two_theta_range, step)

    experiment_folder = '.\\2025_06_25_025_5076_015\\'
